struct ScaledDiagonallyDominantBridge{T,F,VBS} <:
...
function MOI.Bridges.Constraint.bridge_constraint(
    ...
    Q, variable_bridge = add_matrix_variable_bridge(
        model,
        SOS.ScaledDiagonallyDominantConeTriangle,
        MOI.side_dimension(s),
        T,
    )
...
function MOI.get(
    bridge::ScaledDiagonallyDominantBridge{T,F},
...
function MOI.delete(
    ...
    return MOI.delete(model, bridge.variable_bridge)
end
