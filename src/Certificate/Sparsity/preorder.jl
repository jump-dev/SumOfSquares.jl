"""
    struct Preorder{S <: Sparsity, C <: AbstractPreorderCertificate} <: AbstractPreorderCertificate
        sparsity::S
        certificate::C
    end
...
"""
struct Preorder{S <: Sparsity, C <: SumOfSquares.Certificate.AbstractPreorderCertificate} <: SumOfSquares.Certificate.AbstractPreorderCertificate
    sparsity::S
    certificate::C
end
...
function SumOfSquares.Certificate.get(certificate::Preorder, attr::SumOfSquares.Certificate.PreorderIndices, domain::SparseDomain)
    return SumOfSquares.Certificate.get(certificate.certificate, attr, domain.processed)
end

function SumOfSquares.Certificate.get(::Preorder, ::SumOfSquares.Certificate.MultiplierBasis, index::SumOfSquares.Certificate.PreorderIndex, domain::SparseDomain)
...
function SumOfSquares.Certificate.get(certificate::Preorder, attr::SumOfSquares.Certificate.Generator, index::SumOfSquares.Certificate.PreorderIndex, domain::SparseDomain)
    return SumOfSquares.Certificate.get(certificate.certificate, attr, index, domain.processed)
end

SumOfSquares.Certificate.get(certificate::Preorder, attr::SumOfSquares.Certificate.IdealCertificate) = SparseIdeal(certificate.sparsity, SumOfSquares.Certificate.get(certificate.certificate, attr))
SumOfSquares.Certificate.get(::Type{<:Preorder{S, C}}, attr::SumOfSquares.Certificate.IdealCertificate) where {S, C} = SparseIdeal{S, SumOfSquares.Certificate.get(C, attr)}
